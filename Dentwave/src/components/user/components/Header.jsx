...
<div
  ...
  onMouseEnter={e => {
    if (user?.role !== 'user') e.currentTarget.style.background = '#e2e6ea';
  }}
  onMouseLeave={e => {
    e.currentTarget.style.background = '';
  }}
  title={user?.role === 'admin' ? 'Go to Admin Dashboard' : user?.role === 'doctor' ? 'Go to Doctor Dashboard' : ''}
>
  ...
  {user?.role !== 'user' && (
    <span style={{
      ...
      backgroundColor: user?.role === 'admin' ? '#0d6efd' : '#198754',
