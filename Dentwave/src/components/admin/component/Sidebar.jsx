...
import {
  ...
  Briefcase, Stethoscope, LogOut, Activity, ChevronRight
} from 'lucide-react';

const NAV = [
  {
    section: 'Overview',
    items: [{ label: 'Dashboard', icon: LayoutDashboard, path: '/admindashboard' }]
  },
  {
    section: 'Management',
    items: [
      { label: 'Appointments', icon: Calendar,    path: '/appointmentmanagement' },
      { label: 'Patients',     icon: Users,       path: '/patientmanagement'     },
      { label: 'Doctors',      icon: Stethoscope, path: '/doctormanagement'      },
      { label: 'Services',     icon: Briefcase,   path: '/servicemanagement'     },
    ]
  },
  {
    section: 'System',
    items: [{ label: 'Users', icon: UserCog, path: '/usermanagement' }]
  }
];
      ...
      <aside className="dw-sidebar">
        ...
        <div className="dw-brand">
          ...
          <div>
            ...
            <div className="dw-brand-sub">Admin Portal</div>
          </div>
        </div>
        ...
        <div className="dw-sidebar-footer">
          <div className="dw-user-card" onClick={() => navigate('/admin/profile')}>
